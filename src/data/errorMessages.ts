export const ERROR_MESSAGES = {
  ...
  CUSTOMER_ID_FOR_ORDERS_NOT_FOUND: (id: string) => `Not found customer with ID: ${id}`,
  ...
  PRODUCT_IS_NOT_REQUESTED_IN_ORDER: (id: string) => `Product with Id '${id}' is not requested`,
