...
test.describe('[API] [Orders] Delete order by id', () => {
  ...
  test.describe('Positive', () => {
    test('204 No Content - Delete order by id',
  ...
  test.describe('Negative', () => {
    test('401 Unauthorized - Delete order with invalid token',
    ...
    test('401 Unauthorized - Delete order with empty token',
      { tag: [TAGS.API, TAGS.ORDERS, TAGS.REGRESSION] },
    ...
    test('404 Not Found - Delete not exist order',
      { tag: [TAGS.API, TAGS.ORDERS, TAGS.REGRESSION] },
